...
if(isset($_POST['login']) && !isset($_POST['admin'])){
    ...
    if(isset($check) && isset($_POST['login'])){
        echo "<script>
...
if(isset($_POST['register'])){
    ...
    if(empty($name) || empty($email) || empty($password)){
        ...
        $userClass->register($name,$password,$email);
    }
}
...
<div id="loginerrorModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Invalid name or Password</h4>
            </div>

            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Ok, i got the idea </button>
            </div>
        </div>
